---
title: "Entry Point Modules in @pro/main Explained"
sidebarTitle: "Entry Points"
description: "How backtest.ts, live.ts, paper.ts, and session.ts gate on CLI flags, load registered schemas, and dispatch parallel background runners or Telegram auth."
---
