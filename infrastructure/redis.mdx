---
title: "Redis Caching Layer for Fast O(1) Context Lookups"
sidebarTitle: "Redis"
description: "Understand how Redis powers the BaseMap O(1) lookup cache, key namespacing with TTL controls, SCAN-based iteration, and how to start the bundled Docker service."
---
