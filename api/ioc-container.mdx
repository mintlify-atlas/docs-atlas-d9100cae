...
description: "Understand the symbol-keyed IoC container powering @pro/core: how services are registered with provide(), resolved with inject(), and surfaced as core.xService globals."
---
...
const screenServices = {
  cryptoYodaScreenService: inject<CryptoYodaScreenService>(
