...
description: "Complete reference for every environment variable, how CC_SYMBOL_LIST is parsed, when Telegram credentials are required, and how to create your local .env file."
---
