---
title: "Configure Persistence Adapters for Live and Backtest Modes"
sidebarTitle: "Persistence Config"
description: "Understand how setup.config.ts wires each backtest-kit subsystem to a Mongo, memory, or local-file adapter, and how to swap any one in a single line."
---
