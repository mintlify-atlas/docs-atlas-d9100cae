---
title: "Parallel Backtest for All 9 Symbols via Mode A Entry"
sidebarTitle: "Mode A: Parallel"
description: "How --entry activates backtest.ts parallel runner, pre-warms candles via --cache, and runs 9 symbols concurrently in one Node process."
---
