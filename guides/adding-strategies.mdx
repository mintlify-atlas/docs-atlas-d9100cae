...
description: "Drop a strategy directory under ./content/, wire its exchange and frame schemas, and let the CLI load it by path — no rebuild or DI changes needed."
---
