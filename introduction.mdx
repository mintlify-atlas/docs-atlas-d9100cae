---
title: "backtest-monorepo-parallel: Fast Parallel Backtesting in TypeScript"
sidebarTitle: "Introduction"
description: "A TypeScript monorepo template that runs 9 symbols concurrently in a single Node process, hitting ~6 300× real-time speed with Redis caching and atomic Mongo upserts."
---
...
| `di-kit` | latest | Symbol-keyed IoC container (`createActivator`) |
...
| `ccxt` | latest | Exchange client for candle fetching |
