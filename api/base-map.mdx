---
title: "BaseMap: Namespaced Redis Key-Value Map with TTL in @pro/core"
sidebarTitle: "Base Map"
description: "Explore BaseMap, a di-factory Redis wrapper that provides namespaced key-value storage, optional TTL expiry, streaming iteration, and async SCAN-based bulk operations."
---
