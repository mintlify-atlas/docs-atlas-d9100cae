...
description: "Register addExchangeSchema with getCandles, getOrderBook, getAggregatedTrades, formatPrice, and formatQuantity using ccxt.binance or a custom data adapter."
---
