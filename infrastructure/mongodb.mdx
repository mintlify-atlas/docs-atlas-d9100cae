...
description: "How MongoDB provides durable persistence for live-mode subsystems, how atomic upserts work, and which adapters switch to in-memory during backtest replay."
---
