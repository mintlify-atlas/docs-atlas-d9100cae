...
description: "Learn how BaseCRUD wraps a Mongoose Model to provide create, update, find, iterate, and paginate methods — and how CandleDbService extends it with atomic upserts."
---
