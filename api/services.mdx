---
title: "Core Services Reference: Logger, Scraper, Parser & Candle DB"
sidebarTitle: "Core Services"
description: "Full API reference for the four services registered in @pro/core: LoggerService, ScraperService, ParserService, CandleDbService, and CryptoYodaScreenService."
---
...
3. Calls `client.iterMessages(channel, { offsetDate: Math.floor(dayEnd / 1000) + 1 })`
